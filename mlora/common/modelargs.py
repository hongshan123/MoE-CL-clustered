...
available_routing_strategies = ["mixtral", "switch", "my-test"]
available_balance_strategies = ["mixtral", "switch", "my-test"]
...
class MixConfig(LoraConfig):
    ...
    def from_config(self, config: Dict[str, any]) -> "MixConfig":
        ...
        # self.routing_strategy_ = config.get("routing_strategy", "my-test")
        # self.balance_strategy_ = config.get("balance_strategy", "my-test")
        # self.router_loss_ = config.get("router_loss", False)
        ...
        # elif self.routing_strategy_ == "my-test":
        #     self.router_init_range_ = config.get("router_init_range", 0.02)
        #     self.jitter_noise_ = config.get("jitter_noise", 0.0)
        #     self.top_k_ = config.get("top_k", 2)
        # elif self.routing_strategy_ == "switch":
        ...
        #     self.router_aux_loss_coef_ = config.get(
        #         "router_aux_loss_coef", 0.001)  # for training
        # elif self.balance_strategy_ == "my-test":
        #     self.router_aux_loss_coef_ = config.get(
        #         "router_aux_loss_coef", 0.001)  # for training
